...
- [ ] T004 Define task-level validation packet (`What / Why / How to test / Expected / Logs`) in Japanese
...
- [ ] T011 Define requirement renegotiation trigger for infeasible implementation paths
...
- If tests are included, verify tests fail before implementing
- Commit and push after each task or meaningful checkpoint
- Create a PR at the end of each sprint and summarize validation results in Japanese
- Keep task descriptions, verification notes, and code comments in Japanese
- If implementation feasibility drops, stop and consult customer before forcing scope
