...
- 新しいブランチで最初の commit / push を行った場合は、必ずその時点で PR(Draft) を作成する
...
- 作業完了時は、最新の変更内容・検証結果・残課題を反映して既存 PR(Draft or Ready for review) を更新する
...
- PR が `MERGED` または `CLOSED` の場合はその PR を編集せず、main ブランチから新しいブランチを切って新規 PR を作成する
